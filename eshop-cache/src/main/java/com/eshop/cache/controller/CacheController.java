...
import com.eshop.cache.model.ShopInfo;
import com.eshop.cache.rebuild.RebuildCacheQueue;
...
public class CacheController {
	...
	public ProductInfo getProductInfo(Long productId) {
		...
		if(productInfo == null) {
			...
			String productInfoJSON = "{\"id\": 5, \"name\": \"iphone7手机\", \"price\": 5599, \"pictureList\":\"a.jpg,b.jpg\", \"specification\": \"iphone7的规格\", \"client\": \"iphone7的售后服务\", \"color\": \"红色,白色,黑色\", \"size\": \"5.5\", \"shopId\": 1, \"modifiedTime\": \"2017-01-01 12:01:00\"}";
